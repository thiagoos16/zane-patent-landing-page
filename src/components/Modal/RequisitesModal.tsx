import {
    ...
    ModalBody,
    ModalCloseButton,
    Button, Box, Tabs, TabList, TabPanels, Tab, TabPanel, Text,
    Accordion,
    AccordionItem,
    AccordionButton,
    AccordionPanel,
...
export function RequisitesModal({ isOpen, onRequestClose }: NewRequisitesModalProps) {
    return (
        // scrollBehavior="inside"
        <Modal isOpen={isOpen} size="3xl" onClose={onRequestClose}>
            <ModalOverlay />
            <ModalContent>
                    ...
                    <Tabs>
                        ...
                        <TabPanels sx={{"max-height": "calc(100vh - 300px)", "overflow-y":"auto"}}>
                            <TabPanel>
                                ...
                                <br/>
                                <Text textAlign="justify" mr="1" sx={{"text-indent":"50px"}}>
